...
def user_photo_profil_path(instance, filename):
    """Photo de profil utilisateur, organisée par tenant."""
    schema = get_tenant_schema()
    pk = instance.pk or 'new'
    return f'tenants/{schema}/profils/{pk}{_ext(filename)}'
...
class CustomUser(AbstractUser):
    ...
    photo_profil = models.ImageField(
        "Photo de profil", upload_to=user_photo_profil_path, blank=True, null=True,
    )
