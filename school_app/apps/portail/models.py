...
def portail_logo_path(instance, filename):
    """Logo du portail parent, organisé par tenant."""
    schema = get_tenant_schema()
    return f'tenants/{schema}/portail/logo{_ext(filename)}'
...
class PortailConfig(models.Model):
    ...
    logo = models.ImageField(upload_to=portail_logo_path, null=True, blank=True)
