...
def carte_logo_path(instance, filename):
    """Logo pour les cartes d'élève, organisé par tenant."""
    schema = get_tenant_schema()
    return f'tenants/{schema}/cartes/logo{_ext(filename)}'
...
class CarteConfig(models.Model):
    ...
    logo_override      = models.ImageField(upload_to=carte_logo_path, blank=True, null=True,
